              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    TextFormField(
                      validator: (eml) => eml.isEmpty || !eml.contains('@')
                          ? "Enter correct email"
                          : null,
                    ...
                    TextFormField(
                      obscureText: true,
                      validator: (psw) => psw.length < 6
                          ? "Enter password minimum 6 chars length"
                          : null,
                      decoration: little_radius_border.copyWith(
                          hintText: "password",
                          contentPadding: EdgeInsets.symmetric(
                          ...
                          child: FlatButton(
                            ...
                            onPressed: () async {
                              if (_key.currentState.validate()) {
                                ...
                                dynamic result = await _authience
                                    .registerWithEmailAndPassword(
                                        email, password);
                                if (result == null) {
                                  setState(() {
                                    loading = false;
                                    errorMessage = "Please check syntax of your email and password ";
                                  }
                                  );
                                  print("Coś się yłebo");
                                } else {
